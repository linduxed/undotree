...
let s:keymap += [['FocusTarget','f','Set Focus to editor']]
...
let s:keymap += [['GoNext','u','Revert to next state']]
let s:keymap += [['GoPrevious','e','Revert to previous state']]
let s:keymap += [['Redo','Z','Redo']]
let s:keymap += [['Undo','z','Undo']]
